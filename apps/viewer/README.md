...
elevation. It also derives mantle-hotspot trails, volcanic-arc fields, and
craton strength from the final state without modifying elevation. Volcanic arcs
group mixed-crust convergent boundaries by overriding continental plate, walk a
bounded distance inland, and retain strength-ranked peak candidates. Craton
strength is limited to continental land and ramps with graph distance from final
...
composed-elevation, hotspot, volcanic-arc, craton, motion, and final-boundary
diagnostics and reports their aggregate statistics plus stage timings. Plate interiors use
