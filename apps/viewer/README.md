...
partition, static crust classification, and angular velocities; toggles
topology, plate, crust, motion, and boundary diagnostics; and reports stage
timings. Plate interiors use stable per-plate colors. Crust is blue for oceanic,
