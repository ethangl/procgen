...
pub use fractal::{
    DerivativeDampedConfig, FractalParameterError, MAX_OCTAVES, NewestOctaveWeight, OctaveConfig,
    OctaveGain, RidgedMultifractalConfig, Validated, amplitude_sum, derivative_damped_fbm_3d,
    derivative_damped_fbm_3d_faded, fbm_3d, ridged_multifractal_3d, ridged_multifractal_3d_faded,
};
pub use gradient::{
